...
#SBATCH --job-name=amiE-evotuning-smal
...
python3 app.py evotune --model "facebook/esm2_t30_150M_UR50D" --epochs 60 --batch-size 128 --tokenizer "facebook/esm2_t33_650M_UR50D" --save-total-limit 80 --lora --take 1.0 --run small
