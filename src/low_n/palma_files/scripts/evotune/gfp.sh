...
python3 app.py evotune --model "facebook/esm2_t33_650M_UR50D" --epochs 80 --batch-size 128 --tokenizer "facebook/esm2_t33_650M_UR50D" --save-total-limit 30 --lora --take 1.0 
