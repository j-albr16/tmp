...
python3 app.py evotune --model "/scratch/tmp/j_albr16/low-n/projects/pas/runs/run1/checkpoint-38980" --epochs 80 --batch-size 128 --tokenizer "facebook/esm2_t33_650M_UR50D" --save-total-limit 80 --lora --take 1.0 
